    ...
    render() {
        ...
        return (
            ...
            <Switch>
                ...
                <div style={{width: '100%', height: '88%'}}><ShowTable APIendpoint="showmedicine" payload={{username:this.props.username}}></ShowTable></div>
                </Route>
                <Route exact path="/dispensation ">
                <div></div><div></div>
                <div style={{width: '100%', height: '88%'}}><ShowTable APIendpoint="showmedicine" payload={{username:this.props.username}}></ShowTable></div>
                ...
                <div style={{width: '100%', height: '88%'}}><ShowTable APIendpoint="showschedule" payload={{ username:this.props.username}}></ShowTable></div>
                </Route>
                <Route exact path="/schedule ">
                <div></div><div></div><div></div>
                    <div></div>
                ...
                <Route exact path="/expertise">
                    ...
                    <div style={{width: '100%', height: '88%'}}><ShowTable APIendpoint="findexpertise" payload={{ doctor_id:this.state.doctor_id}}></ShowTable></div>
                </Route>
                <Route exact path="/expertise ">
